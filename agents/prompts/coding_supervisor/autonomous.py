...
``get-library-docs`` to fetch its documentation. Do this BEFORE planning so
the docs inform your implementation decisions. Skip entirely if the task
involves only internal modules with no unfamiliar external dependencies.
